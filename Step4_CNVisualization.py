...
OutputFolderName_1 = ThisStep_OutputFolderName + "CN_Plot/"
...
for graph_index in range(0, len(region_name_list)):
    ...
    TCN_fig_filename2 = OutputFolderName_1 + "CN_" + region_name + ".png"
    plt.savefig(TCN_fig_filename2, dpi=600)
    plt.close()
    ...
    plt.savefig(CellType_fig_filename2, dpi=600)
    plt.close()
